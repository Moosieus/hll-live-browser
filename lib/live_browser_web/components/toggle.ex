  ...
  def render(assigns) do
    ...
    <div class={["flex text-center", @class]} @rest>
      <button
        ...
        phx-value-by={assigns[:"phx-value-by"]}
      >
        <span
          aria-hidden="true"
          class={"#{translate_x(@toggled)} pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out"}
        >
        </span>
      </button>
