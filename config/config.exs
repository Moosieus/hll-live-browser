...
config :live_browser, LiveBrowserWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [
    formats: [html: LiveBrowserWeb.ErrorHTML, json: LiveBrowserWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LiveBrowser.PubSub,
  live_view: [signing_salt: "9GNkih9+"],
...
config :live_browser, LiveBrowser.Mailer, adapter: Swoosh.Adapters.Local
